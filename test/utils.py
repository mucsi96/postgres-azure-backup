...
conn1 = psycopg2.connect(database="test",
                        host="localhost",
                        user="postgres",
                        password="postgres",
                        port="8082")
conn2 = psycopg2.connect(database="test",
                        host="localhost",
                        user="postgres",
                        password="postgres",
                        port="8083")
...
def cleanup_db():
    ...
    cur1.execute("SELECT table_name FROM information_schema.tables WHERE table_schema = 'public'")
